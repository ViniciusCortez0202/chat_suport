...
void main() {
    ...
    setUp((){
      controller = ChatController(socket: SocketReposoritory(), store: ChatStore());
    });

  test('Sockt id', () {
    
    expect(controller.idSocket.isEmpty, true);
    controller.openSocket("001");
    expect(controller.idSocket.isNotEmpty, true);
